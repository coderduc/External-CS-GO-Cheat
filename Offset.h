...
struct Signatures
{
	const DWORD dwClientState = 0x58ADD4;
	...
	const DWORD dwEntityList = 0x4D534EC;
	const DWORD dwForceAttack = 0x3184A80;
	const DWORD dwForceAttack2 = 0x3184A8C;
	const DWORD dwForceBackward = 0x3184A38;
	const DWORD dwForceForward = 0x3184A44;
	const DWORD dwForceJump = 0x51FD20C;
	const DWORD dwForceLeft = 0x3184A5C;
	const DWORD dwForceRight = 0x3184A50;
	const DWORD dwGameDir = 0x6296F8;
	const DWORD dwGameRulesProxy = 0x52704FC;
	const DWORD dwGetAllClasses = 0xD652CC;
	const DWORD dwGlobalVars = 0x58AAD8;
	const DWORD dwGlowObjectManager = 0x529B3C8;
	const DWORD dwInput = 0x51A4AC8;
	const DWORD dwInterfaceLinkList = 0x9077D4;
	const DWORD dwLocalPlayer = 0xD3EC6C; //Can tim
	const DWORD dwMouseEnable = 0xD44810;
	const DWORD dwMouseEnablePtr = 0xD447E0;
	const DWORD dwPlayerResource = 0x3182DD0;
	const DWORD dwRadarBase = 0x518825C;
	const DWORD dwSensitivity = 0xD55BCC;
	const DWORD dwSensitivityPtr = 0xD55BA0;
	const DWORD dwSetClanTag = 0x89FB0;
	const DWORD dwViewMatrix = 0x4D44E34;
	const DWORD dwWeaponTable = 0x51A5588;
	const DWORD dwWeaponTableIndex = 0x325C;
	const DWORD dwYawPtr = 0xD0340002;
	const DWORD dwZoomSensitivityRatioPtr = 0xD49710;
	const DWORD dwbSendPackets = 0xD41DA;
	const DWORD dwppDirect3DDevice9 = 0xA7030;
	const DWORD m_pStudioHdr = 0x294C;
	const DWORD m_yawClassPtr = 0xD44470;
	const DWORD m_pitchClassPtr = 0x51884F8;
	const DWORD interface_engine_cvar = 0x3E9EC;
	const DWORD convar_name_hash_table = 0x2F0F8;
	const DWORD m_bDormant = 0xED;
	const DWORD model_ambient_min = 0x58DE4C;
	const DWORD set_abs_angles = 0x1D64E0;
	const DWORD set_abs_origin = 0x1D6320;
	const DWORD is_c4_owner = 0x3AF0C0;
	const DWORD force_update_spectator_glow = 0x3A2612;
	const DWORD anim_overlays = 0x2980;
	const DWORD m_flSpawnTime = 0xA370;
	const DWORD find_hud_element = 0x2FF736A0;
}sig;